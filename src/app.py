...
if app_mode == "🏠 Home":
    ...
    It is developed as a B.Tech major project by krishna Sharma and group to showcase the application of AI in healthcare.
                ...
                if st.button("🔬 Predict Lung Cancer Type", key="predict_lung_button", type="primary"):
                    ...
                    if predicted_class_name and confidence_score is not None:
                        ...
                        if "aca" in predicted_class_name.lower():
                            ...
                            st.warning(
                                "Interpretation: The model predicts features consistent with Lung Squamous Cell Carcinoma "
                                "based on learned histopathological image patterns.\n\n"
                                "⚠️ Disclaimer: This result is generated for academic and research purposes only "
                                "and must not be considered a medical diagnosis or clinical recommendation."
                                 )
...
st.markdown(
    ...
    <div style="text-align: center; padding: 10px; color: #777;">
        <p>Bronchogenic Carcinoma Detection | Krishna Sharma &copy; 2024-2025</p>
